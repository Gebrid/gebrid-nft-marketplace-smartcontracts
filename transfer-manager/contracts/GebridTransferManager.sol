...
import "@gebrid/lib-bp/contracts/BpLibrary.sol";

import "./interfaces/ITransferManager.sol";

abstract contract GebridTransferManager is OwnableUpgradeable, ITransferManager {
    ...
    function __GebridTransferManager_init_unchained(
        uint newProtocolFee,

...
contract("RoyaltiesRegistry, test methods", accounts => {
    ...
    it("Get 10% royalties by token, use RoyaltiesRegistryTest (event) ", async () => {
      ...
      const ERC721_V2981 = await TestERC721WithRoyaltiesV2981.new("Gebrid", "GBRD", "https://ipfs.gebrid.com");
	...
	describe("RoyaltiesRegistry methods works:", () => {
      ...
      ERC721_V1OwnUpgrd = await TestERC721RoyaltyV1OwnUpgrd.new("Gebrid", "GBRD", "https://ipfs.gebrid.com");
      ...
      ERC721_V2OwnUpgrd = await TestERC721RoyaltyV2OwnUpgrd.new("Gebrid", "GBRD", "https://ipfs.gebrid.com");
      ...
      ERC721_V1OwnUpgrd = await TestERC721RoyaltyV1OwnUpgrd.new("Gebrid", "GBRD", "https://ipfs.gebrid.com", {from: ownerErc721 });
	...
	describe ("ExternalProviders test:", () => {
		...
		it("using royaltiesProvider v2 legacy", async () => {
			...
			const token = await TestERC721RoyaltyV2Legacy.new("Gebrid", "GBRD", "https://ipfs.gebrid.com");
		...
		it("using royaltiesProvider artBlocks", async () => {
			...
			//deploying contracts
			const token = await TestERC721ArtBlocks.new("Gebrid", "GBRD", "https://ipfs.gebrid.com");

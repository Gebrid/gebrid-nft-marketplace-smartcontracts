...
contract("RoyaltiesRegistry, royalties types test", accounts => {
  ...
  describe("royalties types are set correctly", () => {
    ...
    it("test royalties type = 2, royalties v2", async () => {
      const ERC721_V2OwnUpgrd = await TestERC721RoyaltyV2OwnUpgrd.new("Gebrid", "GBRD", "https://ipfs.gebrid.com", { from: ownerErc721 });
    ...
    it("test royalties type = 3, royalties v1", async () => {
      const ERC721_V1OwnUpgrd = await TestERC721RoyaltyV1OwnUpgrd.new("Gebrid", "GBRD", "https://ipfs.gebrid.com", { from: ownerErc721 });
    ...
    it("test royalties type = 5, royalties 2981", async () => {
      ...
      const ERC721_V2981 = await TestERC721WithRoyaltiesV2981.new("Gebrid", "GBRD", "https://ipfs.gebrid.com", { from: ownerErc721 });

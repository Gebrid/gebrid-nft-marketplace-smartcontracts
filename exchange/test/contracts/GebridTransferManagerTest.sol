...
import "@gebrid/transfer-manager/contracts/TransferExecutor.sol";
import "@gebrid/transfer-manager/contracts/lib/LibDeal.sol";
import "@gebrid/transfer-manager/contracts/lib/LibFeeSide.sol";

import "@gebrid/exchange-interfaces/contracts/IRoyaltiesProvider.sol";

import "../../contracts/libraries/LibOrderData.sol";

contract GebridTransferManagerTest is GebridTransferManager, TransferExecutor {
    ...
    function init____(
        ...
        __GebridTransferManager_init_unchained(newProtocolFee, newCommunityWallet, newRoyaltiesProvider);
    }

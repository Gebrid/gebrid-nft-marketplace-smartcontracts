...
contract("ERC721GebridUser minimal", accounts => {
  ...
  beforeEach(async () => {
    ...
    await token.__ERC721GebridUser_init(name, "GBRD", "https://ipfs.gebrid.com", "https://ipfs.gebrid.com", [], zeroAddress, zeroAddress, { from: tokenOwner });
  });

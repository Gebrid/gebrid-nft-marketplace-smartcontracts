const Testing = artifacts.require("ERC721GebridMinimal.sol");
...
contract("ERC721Gebrid minimal", accounts => {
  ...
  describe("Burn before ERC721GebridMinimal ()", () => {
  ...
  describe("Burn after ERC721GebridMinimal ()", () => {
  ...
  it("mint and transfer by minter, and token created by ERC721Factory ", async () => {
    ...
    resultCreateToken = await factory.methods['createToken(string,string,string,string,uint256)']("name", "GBRD", "https://ipfs.gebrid.com", "https://ipfs.gebrid.com", 1, {from: tokenOwner});
